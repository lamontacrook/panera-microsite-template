...
* Go to <https://github.com/adobe/panera-microsite-template/releases/latest> and download `panera-microsite-template-{version}.zip`
* Upload `panera-microsite-template-{version}.zip` in AEMaaCS's site creation wizard to create a new site from that template.

## Build locally

Alternatively you can build `panera-microsite-template-{version}.zip` locally.
...
1. The site template ZIP file is now located below the template root: `panera-microsite-template-{version}.zip`.
...
* Commit, build and release latest Site Theme related changes in [Site Theme E2E Repo](https://github.com/adobe/panera-microsite-template-theme-e2e).
